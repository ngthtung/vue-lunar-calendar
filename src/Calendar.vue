<template>
  <div class="date-container">
    <div class="month-year">
      <div class="calendar-month">{{ dayOfMonth.format('MM') }}-{{ dayOfMonth.format('YYYY') }}</div>
      <div>
        <button class="month-button" @click.prevent="changeMonth(-1)"><i
            class="month-arrow month-arrow-prev"></i></button>
        <button class="today-button" @click.prevent="jumpToToday">Today</button>
        <button class="month-button" @click.prevent="changeMonth(1)"><i
            class="month-arrow month-arrow-next"></i></button>
      </div>
    </div>
